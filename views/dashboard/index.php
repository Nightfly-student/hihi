                ...
                <div class="row ">
                    ...
                    <form id="text-light" method="POST" action="dashboard/changepassword">
                        ...
                        <label for="password" class="col-4 col-form-label fs-5">Current Password:</label>
                            <div class="col-8">
                                <input type="text" value="" class="form-control" name="password" required="required" id="password">
                            </div>
                        </div>
                        <div class="form-group row pt-2">
                        <label for="password" class="col-4 col-form-label fs-5">New Password:</label>
                            <div class="col-8">
                                <input type="text" value="" class="form-control" name="password" required="required" id="passwordNew">
                            </div>
                        </div>
                        <div class="form-group row pt-2">
                        <label for="password" class="col-4 col-form-label fs-5">Repeat New Password:</label>
                            <div class="col-8">
                                <input type="text" value="" class="form-control" name="password" required="required" id="passwordNewRepeat">
                            </div>
                        </div>
                        <div class="form-group row pt-2">
                            <div class="col-12 text-end">                                
