...
class RestaurantRepository extends Repository
{
    ...
    function getRestaurant($restaurant_id)
    {
        try {
            ...
            $stmt->execute();
            $stmt->setFetchMode(PDO::FETCH_CLASS, 'Models\Restaurantpage');
    ...
    {
        try {
            $sql = ("SELECT restaurant.restaurant_id, restaurant.title, event.event_session_id, event.duration, event.date_time 'food' AS category FROM event_session AS `session`
            INNER JOIN event_session_restaurant as resto ON event.event_session_id = resto.event_session_id
    ...
    function getAllRestaurants()
    {
        try {
            ...
            $stmt->setFetchMode(PDO::FETCH_CLASS, 'Models\AdminRestaurant');
            $restaurants = $stmt->fetchAll();
