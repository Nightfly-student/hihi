...
class DanceRepository extends Repository
{
    function getAll()
    {
        try {
            ...
            $stmt->setFetchMode(PDO::FETCH_CLASS, 'Models\Dancepage');
    ...
    function getAllClubs()
    {
        try {
            ...
            $stmt->setFetchMode(PDO::FETCH_CLASS, 'Models\Club');
            $clubs = $stmt->fetchAll();
    ...
    function getAllVenues()
    {
        try {
            $stmt = $this->connection->prepare("SELECT * FROM venue");
            $stmt->execute();
            $stmt->setFetchMode(PDO::FETCH_CLASS, 'Models\Venue');
    ...
    {
        try {
            $stmt = $this->connection->prepare("SELECT event_session_dance.dance_event_id, event_session_dance.event_session_id, title, dance_session, price, amount_available, date_time, duration, venue_name, body FROM (((event_session_dance 
            ...
            $stmt->setFetchMode(PDO::FETCH_CLASS, 'Models\DanceProgramme');
